...
export LANG=C
export SOURCE_DATE_EPOCH=1530312932
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library ucminf|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/ucminf/libs/symbols.rds
